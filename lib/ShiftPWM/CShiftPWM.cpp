...
void CShiftPWM::SetRGB(int led, unsigned char g,unsigned char b,unsigned char r, int offset){
...
void CShiftPWM::SetAllRGB(unsigned char g,unsigned char b,unsigned char r){
